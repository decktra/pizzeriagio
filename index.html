...
<head>
    ...
    <title>Buta Pizza - Pizza / Restaurant / Coffee / Cafe</title>
        ...
        <div class="container section" id="about_us">
            <div class="col-sm-12 d-flex flex-xs-column">
                ...
                <div class="col-sm-6 img text-center padd_lr0" data-aos="fade-right">
                    <div class="border_on">
                        <img src="img/photos/about-us.jpg" alt="sample" class="about_img" />
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        ...
                                        <img src="img/photos/food-1.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-2.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-3.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-4.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-5.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-6.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-7.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
                        ...
                        <div class="col-sm-6">
                            <a href="javascript:;" class="block">
                                <div class="content">
                                    <div class="filter_item_img">
                                        <i class="fa fa-search-plus"></i>
                                        <img src="img/photos/food-8.jpg" alt="sample" />
                                    </div>
                                    <div class="info">
                                        <div class="name">Demo Project Name</div>
                                        <div class="short">Graphic Design category</div>
